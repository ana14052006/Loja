...
<?php
   ...
   $dao = new CorDao($mysql);
    $cor = $dao->buscarPorId($id);
?>
<br>
        <form method="POST" action="../../controller/controllerCor.php">     

            <br>
            <div class="form-label">
            <div class=" col-md-6 offset-md-3">
                <label for="formGroupExampleInput" class="form-label">Cor:</label>
                <input type="text" name="cor" value="<?=$cor['cor']?>" class="form-control" placeholder="Digite o novo nome da cor:">
            </div>
            </div>

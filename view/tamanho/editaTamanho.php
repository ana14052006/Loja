...
<head>
    ...
    <title>Edição de tamanhos</title>
...
<br> 
        <form method="POST" action="../../controller/controllerTamanho.php">     
            ...
            <div class=" col-md-6 offset-md-3">
                ...
                <input type="text" name="tamanho" value="<?=$tamanho['tamanho']?>" class="form-control" placeholder="Digite o novo nome do tamanho:">
            </div>
            </div>

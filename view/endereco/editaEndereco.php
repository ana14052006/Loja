...
<br>
<br> 
        <form method="POST" action="../../controller/controllerEndereco.php">     

            <br>
            <div class="form-label">
            <div class=" col-md-6 offset-md-3">
                <label for="formGroupExampleInput" class="form-label">Rua:</label>
                <input type="text" name="rua" value="<?=$endereco['rua']?>" class="form-control" placeholder="Digite o novo nome da rua:">
            </div>
            </div>
            ...
            <div class=" col-md-6 offset-md-3">
                ...
                <input type="text" name="numero" value="<?=$endereco['numero']?>" class="form-control" placeholder="Digite o novo numero:">
            </div> 
            </div>
            <br>
            ...
            <div class=" col-md-6 offset-md-3">
                ...
                <input type="text" name="bairro" value="<?=$endereco['bairro']?>" class="form-control" placeholder="Digite o novo nome do bairro:">
            </div> 
            </div>
            <br>
            ...
            <div class=" col-md-6 offset-md-3">
                ...
                <input type="text" name="cep" value="<?=$endereco['cep']?>" class="form-control" placeholder="Digite o novo cep:">
            </div> 
            </div>
            <br>
            ...
            <div class=" col-md-6 offset-md-3">
                ...
                <input type="text" name="cidade" value="<?=$endereco['cidade']?>" class="form-control" placeholder="Digite o novo nome da cidade:">
            </div> 
            </div>
            <br>

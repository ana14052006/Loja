...
<br> 
        <form method="POST" action="../../controller/controllerEndereco.php">     
            ...
            <div class="col-md-6 offset-md-3">
                ...
                <input type="text" name="bairro" class="form-control" placeholder="Digite o nome do bairro:">
            </div>
            </div>
            ...
            <div class="col-md-6 offset-md-3">
                ...
                <input type="text" name="cidade" class="form-control" placeholder="Digite o nome da cidade:">
            </div>
            </div>

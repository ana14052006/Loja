  ...
  <tbody>
    <?php 
        ...
        foreach ($lista as $loja) {
          $daoAdmin = new AdminDao($mysql);
          $admin = $daoAdmin->buscarPorId($loja['tb_admin_idtb_admin']);

          $daoEndereco = new  EnderecoDao($mysql);
          $endereco = $daoEndereco->buscarPorId($loja['tb_endereco_idtb_endereco']);       
    ?>
    
    <tr>
      <td><?=$loja['idtb_loja']?></td>
      <td><?=$loja['nome']?></td>
      <td><?=$loja['cnpj']?></td>
      <td><?=$loja['logotipo']?></td>
      <td><?=$admin['email']?></td>
      ...
      <td>
        <a href="editaLoja.php?id=<?=$loja['idtb_loja']?>" class="btn btn-outline-primary">Editar</a>
        <a href="excluiLoja.php?id=<?=$loja['idtb_loja']?>" class="btn btn-outline-danger">Excluir</a>
      </td>
    </tr>
